...
/**
 * COMPONENT CLIENT per a la pàgina de menús.
 * 
 * EN ANGULAR: Seria el component amb el template i la lògica del selector de dia.
 * Els menús ja arriben com a @Input() (props en React) des del servidor.
 * 
 * Per què és 'use client'?
 * - Necessita useState per al dia seleccionat
 * - Necessita onClick per canviar de dia
 * - Necessita window.open() per obrir la imatge del menú
 */
...
// Props que rep del Server Component pare
...
export default function MenusClient({ menus, initialDay }: MenusClientProps) {
